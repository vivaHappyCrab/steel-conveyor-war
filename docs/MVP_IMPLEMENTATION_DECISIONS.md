...
- Active defense stations units on the Bastion perimeter (visible, contribute FoW); threats in Bastion vision trigger a sortie. Bastion death kills assigned units.
