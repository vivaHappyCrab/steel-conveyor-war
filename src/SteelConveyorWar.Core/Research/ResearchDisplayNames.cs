...
public static class ResearchDisplayNames
{
    private static readonly Dictionary<string, (string Name, string Description)> Ru = new(StringComparer.Ordinal)
    {
        ...
        ["technology.t1.light-bot"] = ("Атака наземных юнитов", "Увеличивает атаку всех наземных юнитов."),
        ...
        ["technology.t1.scout"] = ("Броня наземных юнитов", "Увеличивает броню всех наземных юнитов."),
        ["technology.t1.machine-gun-turret"] = ("Пулемётная турель", "Открывает стационарную пулемётную оборону."),
        ["technology.t1.concrete-walls"] = ("Дополнительный бастион", "Увеличивает лимит бастионов на 1."),
