...
public static class ResearchDisplayNames
{
    private static readonly Dictionary<string, (string Name, string Description)> Ru = new(StringComparer.Ordinal)
    {
        ...
        ["technology.t1.light-bot"] = ("Лёгкий бот", "Открывает производство лёгких боевых ботов."),
        ...
        ["technology.t1.scout"] = ("Разведчик", "Открывает разведчиков и приказ разведки."),
        ["technology.t1.machine-gun-turret"] = ("Пулемётная турель", "Открывает стационарную пулемётную оборону."),
        ["technology.t1.concrete-walls"] = ("Бетонные стены", "Открывает бетонные стены для прикрытия."),
        ...
        ["technology.t2.additional-bastions"] = ("Доп. бастионы", "Позволяет строить дополнительные бастионы."),
